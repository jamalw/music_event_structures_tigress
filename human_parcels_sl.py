...
if  runNum == 0:
    pfn = savedir + "/pvals_srm_v1_test_run2_split_merge_human"
    zfn = savedir + "/zscores_srm_v1_test_run2_split_merge_human"
    rfn = savedir + "/rawWva_srm_v1_test_run2_split_merge_human"
elif runNum == 1:
    pfn = savedir + "/pvals_srm_v1_test_run1_split_merge_human"
    zfn = savedir + "/zscores_srm_v1_test_run1_split_merge_human"
    rfn = savedir + "/rawWva_srm_v1_test_run1_split_merge_human"
