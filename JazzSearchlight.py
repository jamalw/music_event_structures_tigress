...
def corr2_coeff(AB,msk,myrad,bcast_var):
    ...
    diff = JazzWithinAvgOn - JazzBtwnAvgOff
    ...
    for i in range(100): 
        ...
        diff_perm = JazzWithinAvgOn_perm - JazzBtwnAvgOff_perm
...
nib.save(img,'jazz_within_permuted.nii.gz')
np.save('jazz_within_permuted',global_nonans)
